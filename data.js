...
const TIMELINE_EVENTS = [
  // 12:00 AM — The shift starts immediately
  { time: 3,   aiName: 'AI Trend Scout',             icon: '🔭', owner: 'Carter',  dept: 'product', desc: 'Scanned Product Hunt, Reddit, X, and 14 tech newsletters', output: 'Daily trend brief with 3 flagged tools', hoursSaved: 2.0, dollarValue: 150 },
  { time: 12,  aiName: 'AI Bookkeeper',              icon: '🧾', owner: 'Jarrod',  dept: 'finance', desc: 'Processed 143 transactions from yesterday\'s Amex statement', output: 'Categorized, CPA-ready expense report', hoursSaved: 1.5, dollarValue: 200 },
  { time: 25,  aiName: 'Podcast Booker',             icon: '🎙️', owner: 'Chantelle', dept: 'marketing', desc: 'Found 8 podcasts that match Callan\'s audience and pitched 3', output: '3 personalized pitch emails queued for morning send', hoursSaved: 2.0, dollarValue: 250 },

  // 12:30 – 1:30 AM
  { time: 35,  aiName: 'Expense Categorizer',        icon: '💳', owner: 'Jarrod',  dept: 'finance', desc: 'Matched 143 transactions to vendor database — zero clarifying questions', output: 'All transactions auto-categorized with 98% confidence', hoursSaved: 1.0, dollarValue: 150 },
  { time: 50,  aiName: 'Competitive Intelligence Researcher', icon: '🕵️', owner: 'Carter', dept: 'product', desc: 'Deep-researched 4 competitor product launches from this week', output: 'Competitive intel report with pricing analysis', hoursSaved: 3.0, dollarValue: 225 },
  { time: 70,  aiName: 'Affiliate Manager',          icon: '🤝', owner: 'Chantelle', dept: 'marketing', desc: 'Pulled March affiliate performance — clicks, conversions, commissions', output: 'Affiliate dashboard: top 3 partners identified, 2 underperformers flagged', hoursSaved: 1.5, dollarValue: 180 },
  { time: 85,  aiName: 'Audience Analyzer',          icon: '👥', owner: 'Carter',  dept: 'product', desc: 'Profiled next week\'s podcast host — audience, topics, pain points', output: 'Pre-call briefing with 5 talking points and audience overlap', hoursSaved: 1.5, dollarValue: 120 },

  // 1:30 – 3:00 AM
  { time: 100, aiName: 'Revenue Forecaster',         icon: '📈', owner: 'Jarrod',  dept: 'finance', desc: 'Updated cash flow projections with latest revenue data', output: '12-week forecast with variance flags', hoursSaved: 2.0, dollarValue: 300 },
  { time: 115, aiName: 'Workflow Automator',         icon: '⚡', owner: 'Lex',     dept: 'operations', desc: 'Audited 12 active Zapier workflows for failures and slowdowns', output: '2 broken zaps flagged, 3 optimization recommendations', hoursSaved: 1.5, dollarValue: 120 },
  { time: 135, aiName: 'Video Script Writer',        icon: '🎬', owner: 'Kelsey',  dept: 'marketing', desc: 'Drafted scripts for 3 short-form videos from this week\'s best content', output: '3 scripts with hooks, talking points, and CTAs — under 60 sec each', hoursSaved: 2.0, dollarValue: 200 },
  { time: 155, aiName: 'CFO Advisor',                icon: '🧠', owner: 'Jarrod',  dept: 'finance', desc: 'Analyzed Q1 performance against annual targets and modeled 3 scenarios', output: 'Strategic memo: on track at current pace, 2 acceleration levers identified', hoursSaved: 2.5, dollarValue: 400 },
  { time: 175, aiName: 'Product Validation Engine',  icon: '⚖️', owner: 'Carter',  dept: 'product', desc: 'Pressure-tested the new workshop offer against 5 scoring dimensions', output: 'Verdict: BUILD — strong ICP fit, low competition, high margin potential', hoursSaved: 1.5, dollarValue: 200 },

  // 3:00 – 4:30 AM
  { time: 195, aiName: 'Content Calendar Generator',  icon: '📅', owner: 'Callan', dept: 'marketing', desc: 'Drafted full content calendar for the week across all platforms', output: '15 posts: 5 IG, 4 LinkedIn, 3 email, 3 Threads', hoursSaved: 3.0, dollarValue: 375 },
  { time: 215, aiName: 'Social Media Data Analyst',   icon: '📱', owner: 'Kara',   dept: 'marketing', desc: 'Scraped last 10 days of competitor posts and analyzed engagement', output: 'Top 5 hooks, 3 trending themes, engagement heatmap', hoursSaved: 2.5, dollarValue: 200 },
  { time: 230, aiName: 'Email Copywriter',            icon: '✉️', owner: 'Nick',   dept: 'marketing', desc: 'Wrote 3 nurture emails for the post-bootcamp sequence', output: '3 emails: value drop, social proof, soft CTA — all in Nick\'s voice', hoursSaved: 2.0, dollarValue: 250 },
  { time: 245, aiName: 'Hook Specialist',             icon: '🪝', owner: 'Nick',   dept: 'marketing', desc: 'Generated 20 scroll-stopping hooks from top-performing competitor data', output: '20 hooks ranked by predicted engagement, grouped by theme', hoursSaved: 1.5, dollarValue: 180 },
  { time: 260, aiName: 'Campaign Performance Optimizer', icon: '📉', owner: 'Kara', dept: 'marketing', desc: 'Analyzed $12K ad spend across 8 campaigns from last week', output: 'Pause 2 underperformers, scale 3 winners, reallocate $2.4K', hoursSaved: 1.5, dollarValue: 180 },
  { time: 275, aiName: 'Event Scout',                icon: '🗓️', owner: 'Chantelle', dept: 'marketing', desc: 'Found 6 upcoming women\'s business events accepting speakers', output: '6 event briefs with deadlines, audience size, and application links', hoursSaved: 1.5, dollarValue: 150 },

  // 4:30 – 6:00 AM
  { time: 285, aiName: 'Newsletter Writer',           icon: '📰', owner: 'Nick',   dept: 'marketing', desc: 'Drafted Tuesday\'s email newsletter in brand voice', output: '487-word newsletter with subject line and preview text', hoursSaved: 2.0, dollarValue: 250 },
  { time: 300, aiName: 'Instagram Carousel Creator',  icon: '📐', owner: 'Kara',   dept: 'marketing', desc: 'Turned 3 transcript insights into publish-ready carousel PDFs', output: '3 carousel PDFs with branded slides, ready for scheduling', hoursSaved: 2.0, dollarValue: 250 },
  { time: 315, aiName: 'Performance Digest',          icon: '📊', owner: 'Callan', dept: 'marketing', desc: 'Compiled weekly performance across all content channels', output: 'Top 3 posts, engagement trends, recommended pivots', hoursSaved: 1.5, dollarValue: 120 },
  { time: 330, aiName: 'Financial Snapshot Generator', icon: '📊', owner: 'Jarrod', dept: 'finance', desc: 'Generated board-ready P&L summary for March', output: 'One-page financial snapshot with YoY comparison', hoursSaved: 2.0, dollarValue: 350 },
  { time: 345, aiName: 'Budget Tracker',             icon: '💰', owner: 'Jarrod',  dept: 'finance', desc: 'Compared March spend against budget across 8 categories', output: 'Software overspend flagged (+$1.2K), 3 categories under budget', hoursSaved: 1.0, dollarValue: 150 },
  { time: 355, aiName: 'Program ROI Calculator',     icon: '⚖️', owner: 'Jarrod',  dept: 'finance', desc: 'Calculated A2A Spring cohort ROI — cost to run vs. revenue generated', output: 'A2A S26: 4.2x ROI, $187K revenue on $44K operating cost', hoursSaved: 1.5, dollarValue: 250 },

  // 6:00 – 7:00 AM
  { time: 365, aiName: 'Student Onboarding Specialist', icon: '👋', owner: 'Jodi', dept: 'student-success', desc: 'Personalized welcome sequences for 6 new students enrolled yesterday', output: '6 custom onboarding paths with resource links', hoursSaved: 1.0, dollarValue: 80 },
  { time: 375, aiName: 'Progress Tracker',            icon: '📈', owner: 'Jodi',   dept: 'student-success', desc: 'Scanned 312 active students for milestone completion', output: '8 students flagged as at-risk, 3 recommended for spotlight', hoursSaved: 2.0, dollarValue: 150 },
  { time: 385, aiName: 'Community Manager',           icon: '💬', owner: 'Jodi',   dept: 'student-success', desc: 'Scanned all Slack channels for engagement dips and unanswered questions', output: 'Community health report: 4 quiet students, 2 unanswered threads flagged', hoursSaved: 1.0, dollarValue: 80 },
  { time: 395, aiName: 'Content Repurposer',          icon: '♻️', owner: 'Elliot', dept: 'curriculum', desc: 'Converted Thursday\'s training transcript into 8 content pieces', output: '2 carousels, 3 LinkedIn posts, 1 blog draft, 2 email snippets', hoursSaved: 3.0, dollarValue: 375 },
  { time: 405, aiName: 'Framework Designer',          icon: '🔺', owner: 'Elliot', dept: 'curriculum', desc: 'Extracted 2 teachable frameworks from this week\'s Power Play session', output: '2 framework diagrams with step-by-step breakdowns', hoursSaved: 2.0, dollarValue: 250 },
  { time: 415, aiName: 'Assessment Builder',          icon: '📝', owner: 'Elliot', dept: 'curriculum', desc: 'Built a 10-question skill check for Week 6 of A2A', output: 'Quiz with scoring rubric and auto-grade logic', hoursSaved: 1.5, dollarValue: 150 },

  // 7:00 – 8:00 AM — Final push before the team wakes up
  { time: 425, aiName: 'Morning Briefing Agent',      icon: '☕', owner: 'Kinsey', dept: 'operations', desc: 'Compiled overnight Slack, Notion updates, and calendar prep', output: 'Team activity digest + 4 items needing Kinsey\'s attention', hoursSaved: 1.0, dollarValue: 80 },
  { time: 432, aiName: 'Meeting Intelligence Manager', icon: '🎯', owner: 'Kinsey', dept: 'operations', desc: 'Prepped agendas for today\'s 3 meetings from prior action items', output: '3 agendas with carryover tasks and decision points', hoursSaved: 1.0, dollarValue: 80 },
  { time: 438, aiName: 'SOP Architect',               icon: '📋', owner: 'Lex',    dept: 'operations', desc: 'Processed yesterday\'s onboarding call transcript into a draft SOP', output: 'New hire onboarding SOP v1 — 12 steps, ready for Lex to review', hoursSaved: 2.0, dollarValue: 200 },
  { time: 445, aiName: 'Client Story Engine',         icon: '📖', owner: 'Jodi',   dept: 'student-success', desc: 'Indexed 3 new student wins shared in Slack this week', output: '3 stories tagged by industry, program, and result type — ready for sales', hoursSaved: 1.0, dollarValue: 100 },
  { time: 452, aiName: 'Lead Qualifier',              icon: '🔍', owner: 'Jodi',   dept: 'sales', desc: 'Scored 23 new leads from last night\'s webinar against ICP', output: '7 hot leads prioritized, 12 warm for nurture, 4 disqualified', hoursSaved: 1.5, dollarValue: 120 },
  ...
  { time: 464, aiName: 'Case Study Finder',           icon: '📖', owner: 'Jodi',   dept: 'sales', desc: 'Matched each hot lead to the most relevant client success stories', output: '7 personalized proof packages — 2-3 case studies per lead', hoursSaved: 1.5, dollarValue: 180 },
  { time: 470, aiName: 'Follow-Up Sequencer',         icon: '📬', owner: 'Jodi',   dept: 'sales', desc: 'Generated personalized follow-up emails for all 7 hot leads', output: '7 email drafts with proof points, CTAs, and suggested send times', hoursSaved: 2.0, dollarValue: 250 },
  { time: 475, aiName: 'Brand Voice Writer',          icon: '✍️', owner: 'Callan', dept: 'marketing', desc: 'Drafted 3 Instagram captions and a LinkedIn thought-leadership post', output: '4 publish-ready posts in Callan\'s authentic voice', hoursSaved: 1.5, dollarValue: 200 },
  { time: 479, aiName: 'Thumbnail Designer',          icon: '🖼️', owner: 'Kelsey', dept: 'marketing', desc: 'Generated 6 thumbnail options for this week\'s YouTube video', output: '6 thumbnails A/B-ready, ranked by predicted CTR', hoursSaved: 1.0, dollarValue: 120 },
];
